...
try {
    ...
    stmt = conn.createStatement();
        // 쿼리 작성
        String sql = "SELECT * FROM sharedimages";
        ...
        while (rs.next()) {
            ...
            System.out.println("원본 날짜: " + fullDate);
            System.out.println("불러온 제목: " + title);
            System.out.println("불러온 id: " + email);
            System.out.println("불러온 Url: " + imgUrl);
            // SimpleDateFormat을 사용하여 날짜 형식 변환
            SimpleDateFormat inputFormat = new SimpleDateFormat("yyyy/MM/dd EEEE", Locale.ENGLISH);
      ...
      // dateList를 JSON 형태로 변환
        ...
        for (int i = 0; i < dateList.size(); i++) {
            jsonArrayString += "\"" + dateList.get(i) + "\"";
...
<head>
    <meta charset="utf-8" />
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/diary/css/sharedDiary.css">
...
<body class="bg">
<script>
            var dateListJson = <%= jsonArrayString %>;
            console.log(dateListJson); // 로그가 제대로 찍히는지 확인
        </script>
        <script src="${pageContext.request.contextPath}/diary/js/sharedCalender.js"></script>
  <!--사이드 박스 영역-->
  <div class="sideBox">   
        <!--토글 버튼 -->
    ...
    <div class="entire">
        <div class="head1"></div>
        <div class="head2">
            <div class="spring1"></div>
            <div class="spring2"></div>
            <div class="spring3"></div>
            <div class="spring4"></div>
            <div class="spring5"></div>
            <div class="spring6"></div>
            <div class="spring7"></div>
            <div class="spring8"></div>
            <div class="spring9"></div>
            <div class="spring10"></div>
            <div class="spring11"></div>

            <button class="leftArrow">
                <svg xmlns="http://www.w3.org/2000/svg" width="42" height="57" viewBox="0 0 42 57" fill="none">
                    <path
                        d="M41.2128 3.84089V53.1592C41.2128 56.5742 35.9487 58.2843 32.8701 55.8696L1.43129 31.2105C-0.477097 29.7136 -0.477097 27.2865 1.43129 25.7896L32.8701 1.13046C35.9487 -1.28444 41.2128 0.425919 41.2128 3.84089Z"
                        fill="#FFE786" />
                </svg>
            </button>
            <div class="headText">NOVEMBER 2023</div>
            <button class="rightArrow">
                <svg xmlns="http://www.w3.org/2000/svg" width="44" height="57" viewBox="0 0 44 57" fill="none">
                    <path
                        d="M0 53.1591V3.8408C0 0.425834 5.62008 -1.28433 8.90688 1.13037L42.4719 25.7895C44.5094 27.2864 44.5094 29.7135 42.4719 31.2104L8.90688 55.8695C5.62008 58.2844 0 56.5741 0 53.1591Z"
                        fill="#FFE786" />
                </svg>
            </button>
        </div> 
