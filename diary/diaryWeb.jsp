...
try {
    ...
    stmt = conn.createStatement();
        // 쿼리 작성
        String sql = "SELECT date FROM images WHERE email = ?";
...
<head>
    <meta charset="utf-8" />
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/diary/css/diary.css">
...
<script>
        ...
        <script src="${pageContext.request.contextPath}/diary/js/calender.js"></script>
  <!--사이드 박스 영역-->
  <div class="sideBox">   
        <!--토글 버튼 -->
